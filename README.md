...
+ **Mediapipe** - Mediapipe é uma biblioteca desenvolvida pelo google de machine learning  de código aberto  que possui algumas soluções para reconhecimento facial e reconhecimento de gestos, e fornece encapsulamento de python, js e outras linguagens.
